...
```
cd existing_repo
git remote add origin https://forge.univ-lyon1.fr/p2102522/blogphp.git
git branch -M main
...
- [ ] [Set up project integrations](https://forge.univ-lyon1.fr/p2102522/blogphp/-/settings/integrations)
